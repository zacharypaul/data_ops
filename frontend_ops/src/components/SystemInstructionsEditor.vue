  ...
  <div class="space-y-4">
    ...
    <div class="mt-6">
      <div class="flex items-center mb-3">
        <div class="w-6 h-6 rounded-full bg-indigo-900/50 flex items-center justify-center mr-2">
        ...
        <h4 class="text-sm font-medium">Time-Based Instructions</h4>
      </div>
      
      <div class="space-y-2">
        <div class="flex items-center">
          <input type="checkbox" id="time-rules" class="rounded text-indigo-500 focus:ring-indigo-500 bg-dark-800 border-dark-700">
          <label for="time-rules" class="ml-2 text-sm text-dark-300">Enable time-specific instructions</label>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
          <div class="bg-dark-700/50 rounded-md p-3 border border-dark-600">
            <div class="text-xs font-medium mb-2">Business Hours (9am-5pm)</div>
            <div class="text-xs text-dark-400">
              Prioritize immediate assistance and technical support
            </div>
          </div>
          
          <div class="bg-dark-700/50 rounded-md p-3 border border-dark-600">
            <div class="text-xs font-medium mb-2">After Hours</div>
            <div class="text-xs text-dark-400">
              Create tickets for non-urgent issues, solve critical issues only
            </div>
          </div>
        </div>
      </div>
